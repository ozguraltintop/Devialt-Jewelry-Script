...
<head>
        ...
        <title>Ürün Listele - <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body table-responsive">
                                <h5 class="card-title">Ürün Listele</h5>
                           
                                <a href="urun-ekle.php"  class="btn btn-primary m-b-md">Ürün Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Ürün Sırası</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from urunler order by id desc",PDO::FETCH_ASSOC);
