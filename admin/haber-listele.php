...
<head>
        ...
        <title>Haber Listele - <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body table-responsive">
                                <h5 class="card-title">Haber Listele</h5>
                           
                                <a href="haber-ekle.php"  class="btn btn-primary m-b-md">Haber Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Haber Sırası</th>
