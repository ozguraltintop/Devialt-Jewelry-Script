...
imagedestroy($content);
	unlink ('../resimler/'.$resim1);
	 ...
	 $simdi = $db->prepare("insert into galeri set adi=:adi,sira=:sira,resim=:resim,linki=:linki,durum=:durum,aciklama=:aciklama");
...
unlink ('../resimler/'.$resim1);
	 ...
	 $simdi1 = $db->prepare("update galeri set adi=:adi,sira=:sira,resim=:resim,linki=:linki,durum=:durum,
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-floating mb-3">
                                      ...
                                      <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="linki" placeholder="Galeri Linki" value="<?=$guncelle['adi']?>">
