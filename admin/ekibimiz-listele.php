...
<head>
        ...
        <title>Ekibimiz Listele - <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body table-responsive">
                                <h5 class="card-title">Ekibimiz Listele</h5>
                           
                                <a href="ekibimiz-ekle.php"  class="btn btn-primary m-b-md">Ekibimiz Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Ekibimiz Sırası</th>
                                                <th scope="col">Ekibimiz Resmi</th>
                                                <th scope="col">Ekibimiz Adı</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from ekibimiz order by id desc",PDO::FETCH_ASSOC);
