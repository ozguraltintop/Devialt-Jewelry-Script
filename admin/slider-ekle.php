...
$output = '../resimler/'.$random.'-'.$seo.'.jpg';
$resim=$random.'-'.$seo.'.jpg';
...
imagedestroy($content);
	unlink ('../resimler/'.$resim1);
	 ...
	 $simdi = $db->prepare("insert into slider set adi=:adi,sira=:sira,resim=:resim,linki=:linki,durum=:durum,aciklama=:aciklama");
...
unlink ('../resimler/'.$resim1);
	 ...
	 $simdi1 = $db->prepare("update slider set adi=:adi,sira=:sira,resim=:resim,linki=:linki,durum=:durum,
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-floating mb-3">
                                      ...
                                      <div class="form-floating mb-3">
                                        ...
                                        <label for="floatingInput">Slider Linki</label>
                                      </div>
