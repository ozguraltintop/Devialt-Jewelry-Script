...
unlink ('../resimler/'.$img);
		...
		<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                          <strong>Hizmet Başarıyla Eklendi!</strong>
...
unlink ('../resimler/'.$img);
	...
	if($ekle1){
		...
		<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                          <strong>Hizmet Başarıyla Güncellendi!</strong> 
                          <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                        </div>
...
if($_GET['islem']=='duzenle'){
	...
	$guncelle = $db->query("select * from hizmetler where id='$gid'")->fetch(PDO::FETCH_ASSOC);
}
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="sira" placeholder="Hizmet Sırası" value="<?=$guncelle['sira']?>">
                                        <label for="floatingInput">Hizmet sırası</label>
                                      </div>
                                      
                                      
                                           <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="adi" placeholder="Hizmet Adı" value="<?=$guncelle['adi']?>">
                                        <label for="floatingInput">Hizmet Adı</label>
                                      </div>
