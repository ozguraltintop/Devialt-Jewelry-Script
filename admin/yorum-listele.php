                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body table-responsive">
                                ...
                                <a href="yorum-ekle.php"  class="btn btn-primary m-b-md">Yorum Ekle</a>
                                <table class="table invoice-table">
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from yorumlar ",PDO::FETCH_ASSOC);
											if($urunlistele->rowCount()){foreach($urunlistele as $urungoster){
											?>
                                              <tr>
                                                <th scope="row"><?=$urungoster['adi']?></th>
                                                <td><img src="../resimler/<?=$urungoster['resim']?>"> </td>
