                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="sira" placeholder="Haber Sırası" value="<?=$guncelle['sira']?>">
                                        <label for="floatingInput">Haber sırası</label>
                                      </div>
                                      
                                      
                                           <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="adi" placeholder="Haber Adı" value="<?=$guncelle['adi']?>">
                                        <label for="floatingInput">Haber Adı</label>
                                      </div>
