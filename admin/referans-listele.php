...
<head>
        ...
        <title>Referanslar Listele - <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body table-responsive">
                                <h5 class="card-title">Referanslar Listele</h5>
                           
                                <a href="referans-ekle.php"  class="btn btn-primary m-b-md">Referanslar Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Referanslar Sırası</th>
                                                <th scope="col">Referanslar Resmi</th>
                                                <th scope="col">Referanslar Adı</th>
