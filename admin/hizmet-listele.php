...
<head>
        ...
        <title>Hizmet Listele - <?=$ayar['site_title']?></title>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body table-responsive">
                                <h5 class="card-title">Hizmet Listele</h5>
                           
                                <a href="hizmet-ekle.php"  class="btn btn-primary m-b-md">Hizmet Ekle</a>
                                <table class="table invoice-table">
                                            <thead>
                                              <tr>
                                                <th scope="col">Hizmet Sırası</th>
                                            ...
                                            <tbody>
                                            <?php
                                            $urunlistele = $db->query("select * from hizmetler order by id desc",PDO::FETCH_ASSOC);
