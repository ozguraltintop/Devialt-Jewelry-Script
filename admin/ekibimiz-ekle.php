...
if($_GET['islem']=='duzenle'){
	...
	$guncelle = $db->query("select * from ekibimiz where id='$gid'")->fetch(PDO::FETCH_ASSOC);
}
...
<head>
        ...
        <title>Ekibimiz Ekle - <?=$ayar['site_title']?></title>
                ...
                <div class="main-wrapper">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Ekibimiz  Ekle</h5>
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <div class="mb-3">
                                        <label for="formFile" class="form-label">Ekibimiz Resmi</label>
                             ...
                             <div class="col-md-4 " style="margin:auto;padding:auto;">
				                    <div class="uploaddis aktif" data-id="1" style="margin:0 auto;">
				        			  <div class="upload1">
				        				  <span class="metin" style="width: 100%;float: left;">Ekibimiz Resimi Yükle</span>
