...
$klasord="../resimler/";
	...
	else
	{
	 ...
	 $simdi = $db->prepare("insert into referanslar set adi=:adi,sira=:sira,resim=:resim,linki=:linki,durum=:durum,aciklama=:aciklama");
	...
	if($ekle){
		...
		<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                          <strong>Referans Başarıyla Eklendi!</strong> 
...
if($_POST['kaydet'] and $_GET['islem']=='duzenle'){
	...
	else
	{
	 ...
	 $simdi1 = $db->prepare("update referanslar set adi=:adi,sira=:sira,resim=:resim,linki=:linki,durum=:durum,
	...
	if($ekle1){
		...
		<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                          <strong>Referans Başarıyla Güncellendi!</strong> 
                          <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                        </div>
...
<head>
        ...
        <title>Referanslar Ekle - <?=$ayar['site_title']?></title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-floating mb-3">
                                      ...
                                      <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="linki" placeholder="Slider Linki" value="<?=$guncelle['adi']?>">
                                        <label for="floatingInput">Referans Linki</label>
                                      </div>
