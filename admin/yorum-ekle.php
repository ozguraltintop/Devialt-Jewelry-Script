...
imagedestroy($content);
	unlink ('../resimler/'.$resim1);
	 ...
	 $simdi = $db->prepare("insert into yorumlar set linki=:linki,adi=:adi,sira=:sira,resim=:resim,kategori=:kategori,durum=:durum,onaciklama=:onaciklama,aciklama=:aciklama,seo=:seo,tur=:tur,eklenme_tarihi=:eklenme_tarihi");
	$ekle = $simdi->execute(array("linki"=>$_POST['linki'],"adi"=>$adi,"sira"=>$sira,"resim"=>$resim,"kategori"=>$kategori,"aciklama"=>$aciklama,"seo"=>$seo,"tur"=>$tur,"onaciklama"=>$onaciklama,"durum"=>$durum,"eklenme_tarihi"=>$tarih));
	if($ekle){
...
unlink ('../resimler/'.$resim1);
	...
	if(isset($_POST['img'])){
	 ...
	 $simdi1 = $db->prepare("update yorumlar set linki=:linki,adi=:adi,sira=:sira,resim=:resim,kategori=:kategori,durum=:durum,onaciklama=:onaciklama,aciklama=:aciklama,seo=:seo,tur=:tur,guncelleme_tarihi=:guncelleme_tarihi where id=:id");
	$ekle1 = $simdi1->execute(array("linki"=>$_POST['linki'],"adi"=>$adi,"sira"=>$sira,"resim"=>$resim,"kategori"=>$kategori,"aciklama"=>$aciklama,"seo"=>$seo,"tur"=>$tur,"onaciklama"=>$onaciklama,"durum"=>$durum,"guncelleme_tarihi"=>$tarih,"id"=>$id));
	if($ekle1){
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="floatingInput">Yorum sırası</label>
                                      </div>
                                      
                                      
                                           <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="adi" placeholder="Ürün Adı" value="<?=$guncelle['adi']?>">
                                        <label for="floatingInput">Yorum Adı</label>
                                      </div>
                                      
                                           <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="linki" placeholder="Ürün Adı" value="<?=$guncelle['linki']?>">
                                        ...
                                        <div class="mb-3">
                                        <label for="formFile" class="form-label">Yorum Resmi</label>
