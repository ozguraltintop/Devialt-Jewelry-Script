<section class="middle">
				...
				<?php
                $urunkatcek=$db->query("select * from urunler where kategori='$id' and durum='on' order by id desc")->fetchAll(PDO::FETCH_ASSOC);
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="product_grid card b-0">
								<div class="badge bg-success text-white position-absolute ft-regular ab-left text-upper">YENİ</div>
								    ...
								    <input type="hidden" name="urun" value="<?=$urunka['id']?>">
								    <input type="hidden" name="link" value="../../<?=$_GET['seo']?>">
